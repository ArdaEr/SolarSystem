...
public class LevelInitializer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (var planet in levelData.Planets)
        {
            ...
            if (planetObject.GetComponent<RotateAroundSample>()!=null)
            {
                planetObject.GetComponent<RotateAroundSample>()._targetObject=_star.transform;
            }
            ...
            foreach (var moon in planet.Moons)
            {
                ...
                if (moonObject.GetComponent<RotateAroundSample>()!=null)
            {
                moonObject.GetComponent<RotateAroundSample>()._targetObject=planetObject.transform;
            }
            }
        }
    }
